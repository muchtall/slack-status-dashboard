...
#standard_emoji_response = urllib.urlopen('https://raw.githubusercontent.com/iamcal/emoji-data/master/emoji.json')
#standard_emoji = json.loads(standard_emoji_response.read())
...
while True:
  ...
  html_output.append('</head><body><table style="text-align: left; font-family: \'Slack-Lato\'">')
  ...
  with open('slack-status-dashboard.html', mode='wt', encoding='utf-8') as myfile:
    myfile.write('\n'.join(html_output))
